...
import java.util.Scanner;
	...
	public class SaleCommodity extends Commodity{
		...
		public SaleCommodity(String commodityName, int price, int units, double persent){
			super(commodityName, price, units);
			this.persent = persent;
		}
		public SaleCommodity(Scanner sc) {
			super(sc);
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			SaleCommodity other = (SaleCommodity) obj;
